...
1. Pet activity events are captured via app or device  
2. Events are ingested through APIs and pushed to an event stream  
3. Prediction engine consumes events and evaluates recent + historical patterns  
4. System computes the next probable potty window  
5. Notification service asynchronously sends alerts  
